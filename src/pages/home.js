                        ...
                        >
                          ...
                          <div className="swap-Box01">
                            <div className="icon-Box icon02">
                              <svg>
                                <g>
                                  <path class="cst1" d="M36.3,16.3h-3.6v-3.9C32.7,5.6,27.1,0,20.3,0S7.9,5.6,7.9,12.4v3.9H5.6c-3.1,0-5.6,2.5-5.6,5.6v20.8
                                  ...
                                  <path class="cst0" d="M25.9,30c0-2.8-2.3-5-5-5c-2.7,0-5,2.3-5,5c0,2.2,1.5,4.1,3.5,4.7v3.2c0,0.8,0.7,1.5,1.5,1.5s1.5-0.7,1.5-1.5
                          ...
                          <div className="swap-Box01">
                            <div className="icon-Box icon05">
                              <svg>
                                <g>
                                  <path class="cst0" d="M26,35.8v3h-2.7v-3c-2.7-0.2-5.3-1-6.7-2.2l1.5-3.3c1.3,1,3.3,1.7,5.3,1.9v-4.5c-3-0.7-6.4-1.7-6.4-5.6
                                  ...
                                  <path class="cst1" d="M50.2,0.4c-0.6-0.6-1.6-0.6-2.1,0l-7.7,7.7c-4.3-4-10-6.4-16.3-6.4c-13.2,0-24,10.8-24,24
                          ...
                          <div className="swap-Box01">
                            <div className="icon-Box icon07">
                              <svg>
                                <g>
                                  <path class="cst0" d="M42.2,37.6H16c-3.1,0-5.7-2.5-5.7-5.7V5.7C10.3,2.5,12.8,0,16,0h26.3c3.1,0,5.7,2.5,5.7,5.7v26.3
                                  ...
                                  <path class="cst1" d="M17.7,39.8v3.5c0,1.4-1.1,2.6-2.6,2.6H5.7c-1.4,0-2.6-1.1-2.6-2.6v-9.4c0-1.4,1.1-2.6,2.6-2.6H8v-3.1H5.7
                            ...
                            <div className="icon-Box icon09">
                              <svg>
                                ...
                                <g>
                                  ...
                                  <path class="cst1" d="M9.4,18.8C4.2,18.8,0,14.6,0,9.4S4.2,0,9.4,0c5.2,0,9.4,4.2,9.4,9.4S14.5,18.8,9.4,18.8 M9.4,3.4
                                    c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S12.7,3.4,9.4,3.4"/>
                                  <path class="cst1" d="M15.1,55.1c-3,0-5.4-2.4-5.4-5.4c0-3,2.4-5.4,5.4-5.4s5.4,2.4,5.4,5.4C20.5,52.7,18.1,55.1,15.1,55.1
                                    M15.1,47.7c-1.1,0-2,0.9-2,2c0,1.1,0.9,2,2,2c1.1,0,2-0.9,2-2C17.1,48.5,16.2,47.7,15.1,47.7"/>
                                  <path class="cst1" d="M47.9,40.7c-6,0-10.9-4.9-10.9-10.9s4.9-10.9,10.9-10.9c6,0,10.9,4.9,10.9,10.9S54,40.7,47.9,40.7 M47.9,22.2
